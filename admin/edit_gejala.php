...
if (isset($_GET['id'])) {
    ...
    if (!$gejala) {
        echo "<p style='color:red;text-align:center;'>Gejala tidak ditemukan!</p>";
        exit;
    }
} else {
...
if (isset($_POST['update'])) {
    ...
    mysqli_query($koneksi, "UPDATE gejala SET kode_gejala='$kode', nama_gejala='$nama' WHERE id_gejala=$id");
...
<body>
    <div class="content-wrapper">
        ...
        <form method="POST">
            <input type="text" name="kode_gejala" value="<?= htmlspecialchars($gejala['kode_gejala']) ?>" placeholder="Kode Gejala" required>
            <input type="text" name="nama_gejala" value="<?= htmlspecialchars($gejala['nama_gejala']) ?>" placeholder="Nama Gejala" required>
            <button type="submit" name="update">Perbarui Data</button>
        </form>

        <a href="gejala.php" class="back-btn">🏠 Kembali ke Kelola Gejala</a>
    </div>
</body>
</html>
